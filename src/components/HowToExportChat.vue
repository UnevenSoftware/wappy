<template>
  <div class="mt-10 text-center">
    <div class="p-4 rounded-lg shadow-lg space-y-6 dark:bg-dark-bglayer-1 bg-light-bglayer-1">
      ...
      <!-- apple -->
      <div
        class="text-2xl text-blue-500 shadow-lg text-primarylight font-bold rounded-lg dark:bg-dark-bglayer-2 bg-light-bglayer-2"
      >
        <div class="rounded-lg p-6 w-full flex">
        ...
        <ul
          class="text-lg text-left text-blue-500 font-medium rounded-b-lg px-8 py-4 space-y-4 dark:bg-dark-bglayer-3 bg-light-bglayer-3 dark:text-dark-text text-light-text"
        >
